            ...
            <form class="" id="" name="" method="post" action="modificationinfoemployes.php">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type="hidden" name="id" class="form-control" placeholder="id"
                            value="<?php echo $_SESSION['user']['idemp']; ?>">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="date" name="date" class="form-control" placeholder="Date de naissance"
                            value="<?php echo $_SESSION['user']['dateNaissance']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <label>Nom d'utilisateur</label>
                        <input type="text" name="nom" class="form-control" placeholder="Nom d'utilisateur"
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="dep" class="form-control" placeholder="Département"
                            value="<?php echo $_SESSION['user']['departement']; ?>">
                    </div>
                    <div class="form-group col-12">
                        <label>Poste</label>
                        <input type="text" name="poste" class="form-control" placeholder="Poste"
                            value="<?php echo $_SESSION['user']['poste']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <label>Mot de passe</label>
                        <input type="password" name="mt" class="form-control" placeholder="mot de passe"
                            value="<?php echo $_SESSION['user']['motdepasse']; ?>">
                    </div>
                </div>
