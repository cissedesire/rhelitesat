    ...
    <div class="container">
        ...
        <div class="panel panel-success margetop">
            <div class="panel-heading"
                style=" display: inline-block;width: 500px;height: 100px;color:white; font-size:xx-large;">> Rapport des
                congés</div>
                ...
                <table class=tablecontent>
                    ...
                    <tbody>
                        ...
                        <tr class=lignecolor>
                            ...
                            <td>
                                <a onclick="return confirm('Etes vous sûr de vouloir supprimer le congé')"
                                    href="supprimercongeaccepter.php?idconge=<?php echo $conges['idconge'] ?>"><i
