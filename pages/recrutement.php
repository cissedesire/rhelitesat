                    ...
                    <div class="panel-body">
                        <table class=tablecontent>
                            ...
                            <tbody>
                                ...
                                <tr class=lignecolor>
                                    ...
                                    <td>
                                        <a href="visualisercandidat.php?idcand=<?php echo $candidats['idcand'] ?>"><i
                                                class="material-icons" data-toggle="tooltip"
                                                title="see">visibility</i></a>
                                        <a onclick="return confirm('Etes vous sûr de vouloir supprimer')"
                                            href="supprimercandidat.php?idcand=<?php echo $candidats['idcand'] ?>"><i
                                                class="material-icons" data-toggle="tooltip"
                                                title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                        ...
                        <div>
                            <ul class="pagination">
                                ...
                                <li><a
                                        href="recrutement.php?page=<?php echo $i; ?>&poste=<?php echo $poste; ?>"><?php echo $i; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
