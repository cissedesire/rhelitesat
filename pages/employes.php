    ...
    <div class="container">
        ...
        <div class="panel panel-success margetop">
            <div class="panel-heading"
                style=" display: inline-block;width: 500px;height: 100px;color:white; font-size:xx-large;">>Liste des
                employés</div>
            ...
            <a href="inscription.php" class="btn btn-primary" style="float: right;">Ajouter un employé</a>
                    ...
                    <div class="panel-body">
                        <table class=tablecontent>
                            ...
                            <tbody>
                                ...
                                <tr class=lignecolor>
                                    <td><img style="width:80px;height:80px;border-radius:500px;"
                                            src="../images/<?php echo $employes['photo'] ?>" /></td>
                                    <td><?php echo $employes['nom'] ?></td>
                                    <td><?php echo $employes['poste'] ?></td>
                                    <td><?php echo $employes['email'] ?></td>
                                    <td><?php echo $employes['telephone'] ?></td>
                                    <td>
                                        <a href="modifieremployes.php?idemp=<?php echo $employes['idemp'] ?>"><i
                                                class="material-icons" data-toggle="tooltip"
                                                title="Edit">&#xE254;</i></a>
                                        <a onclick="return confirm('Etes vous sûr de vouloir archiver l\'employé')"
                                            href="supprimeremployes.php?idemp=<?php echo $employes['idemp'] ?>"><i
                                                class="material-icons" data-toggle="tooltip"
                                                title="Delete">&#xE872;</i></a>
                                        <a
                                            href="activeremployes.php?idemp=<?php echo $employes['idemp'] ?>&etat=<?php echo $employes['etat'] ?>">
                                            <?php
                                                if ($employes['etat'] == 0) { ?>
                        ...
                        <div>
                            <ul class="pagination">
                                ...
                                <li><a
                                        href="employes.php?page=<?php echo $i; ?>&nomE=<?php echo $nomE; ?>"><?php echo $i; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
