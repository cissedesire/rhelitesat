                ...
                <table class=tablecontent>
                    ...
                    <tbody>
                        ...
                        <tr class=lignecolor>
                            ...
                            <td>
                                <a href="modifierannonce.php?idannonce=<?php echo $annoncement['idannonce'] ?>"><i
                                        class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a onclick="return confirm('Etes vous sûr de vouloir supprimer l\'annonce')"
                                    href="supprimerannonce.php?idannonce=<?php echo $annoncement['idannonce'] ?>"><i
