...
<body>
    ...
    <br>
    <div class="container">
        <form id="" name="" method="post" action="modifierinforh.php">
            <div class="row d-flex justify-content-center" style="margin-top:-30px">
                <div class="col-md-10 mt-5 pt-5">
                    <div class="row z-depth-3 d-flex">
                        <div class="col-sm-4 bg-dark rounded-left text-center text-white">
                            <div class="card-block text-center text-white">
                                <img style="width:110px;height:110px;border-radius:500px;margin-top:5px;"
                                    src="../images/<?php echo $_SESSION['user']['photo']; ?>" />
                        ...
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <ul class="list-unstyled d-flex justify-content-center mt-4">
                                <input type="submit" style="background-color:#A9A9A9;color:white;border-radius: 10px;"
