...
<body class="bg-light">
    ...
    <br>
    <div class="container">
        <form class="" id="" name="" method="post" action="congesdemandes.php">
                        ...
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <h6 class=" text-muted"><?php echo $congesdemandes['nom']; ?></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="font-weight-bold">Date debut:</p>
                                    <h6 class="text-muted"><?php echo $congesdemandes['datedebut']; ?></h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="font-weight-bold">Date fin:</p>
                                    <h6 class=" text-muted"><?php echo $congesdemandes['datefin']; ?></h6>
                                </div>
                                <div class="col-sm-6">
                                    <p class="font-weight-bold">Type de conge:</p>
                                    <h6 class="text-muted"><?php echo $congesdemandes['typeconge']; ?></h6>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="font-weight-bold">JUSTIFICATIF</p>
                                    <h6 class="text-muted"><?php echo $congesdemandes['justificatif']; ?></h6><a
                                        href="telechargementjustificatif.php?id=<?php echo $congesdemandes['idemp']; ?>"><i
                                            class="material-icons" data-toggle="tooltip"
                                            title="download">file_download</i></a>
                                </div>
                            </div>
                            <hr class="bg-primary">
                            <ul class="list-unstyled d-flex justify-content-center mt-4">
                                <a style="background: #212121;padding: 10px 18px;text-decoration: none;color: #fff;display: inline-block;margin: 30px 0;border-radius: 5px;"
                                    href="../pages/congesdemandes.php">Retour</a>
                            </ul>
                        </div>
                    </div>
                </div>
