                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="date" name="debutdereunion" class="form-control"
                                    placeholder="date de réunion" id="debut">
                            </div>
                            <div class="form-group col-6">
                                <label for="time">heure de réunion</label>
                                <input type="time" name="heure" class="form-control" placeholder="heure de réunion"
                                    id="heure">
                            </div>
                        </div>
                    </div>
                    ...
                    <table class=tablecontent>
                        ...
                        <tbody>
                            ...
                            <tr class=lignecolor>
                                ...
                                <td>
                                    <a href="modifierreunion.php?idreunion=<?php echo $reunion['idreunion'] ?>"><i
                                            class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a onclick="return confirm('Etes vous sûr de vouloir supprimer la réunion')"
                                        href="supprimerreunion.php?idreunion=<?php echo $reunion['idreunion'] ?>"><i
