...
<body>
            ...
            <form class="" id="" name="" enctype="multipart/form-data" method="post" action="ajouteremployes.php">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="password" name="confirmer le mot de passe" class="form-control"
                            id="confirmpassword" placeholder="Confirmer le mot de passe">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        <input type="submit" class="btn btn-success" id="inscrire" name="submit" value="Ajouter">
                    </div>
                </div>
            </form>
        </div>
    ...
    document.querySelector('#inscrire').onclick = function() {
        ...
        if (password == "" || photo == "" || email == "" || date == "" || nom == "" || tel == "" || dep == "" ||
            poste == "") {
