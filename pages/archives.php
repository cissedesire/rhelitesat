                    ...
                    <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr class=lignecolor>
                                    <td><img style="width:80px;height:80px;border-radius:500px;"
                                            src="../images/<?php echo $employesarchiver['photo'] ?>" /></td>
                                    ...
                                    <td>
                                        <a href="modifieremployesarchives.php?idemp=<?php echo $employesarchiver['idemp']; ?>"
                                            class="edit" data-toggle="modal"><i class="material-icons"
                                                data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a onclick="return confirm('Etes vous sûr de vouloir supprimer l\'employé')"
                                            href="supprimeremployesarchives.php?idemp=<?php echo $employesarchiver['idemp']; ?>"
                        ...
                        <div>
                            <ul class="pagination">
                                ...
                                <li><a
                                        href="archives.php?page=<?php echo $i; ?>&nomE=<?php echo $nomE; ?>"><?php echo $i; ?></a>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
