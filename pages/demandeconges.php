            ...
            <form class="form" id="" name="" method="post" action="ajouterconge.php">
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <input type="file" name="justificatif" class="form-control" placeholder="justificatif">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option>Congé de décès</option>
                            <option>Congé pour raisons familiales</option>
                            <option>Congé sans solde</option>
                            <option>Congé de formation ou de développement professionnel</option>
                            <option>Congé sabbatique</option>
                            <option>Congé de mariage</option>
                            <option>Congé de deuil</option>
                            <option>Congé parental</option>
                            <option>Congé pour examens médicaux</option>
                            <option>Congé pour soins palliatifs</option>
                        </select>
                    </div>
                </div>
