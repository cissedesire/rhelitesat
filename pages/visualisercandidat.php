                        ...
                        <div class="col-sm-4 bg-dark rounded-left" style="color:green">
                            <div class="card-block text-center text-white">
                                ...
                                <h2 class="font-weight-bold mt-4">
                                    <?php echo $candidats['prenom']; ?>&nbsp;<?php echo $candidats['nom']; ?></h2>
                            </div>
                        </div>
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <h6 class="text-muted"><?php echo $candidats['cv']; ?></h6><a
                                        href="telechargementcv.php?id=<?php echo $candidats['idcand']; ?>"><i
                                            class="material-icons" data-toggle="tooltip"
                                            title="download">file_download</i></a>
                                </div>
                                <div class="col-sm-6">
                                    <p class="font-weight-bold">Lettre de Motivation</p>
                                    <h6 class="text-muted"><?php echo $candidats['lettre']; ?></h6><a
                                        href="telechargementlettre.php?id=<?php echo $candidats['idcand']; ?>"><i
                                            class="material-icons" data-toggle="tooltip"
                                            title="download">file_download</i></a>
                                </div>
                            </div>
                            ...
                            <ul class="list-unstyled d-flex justify-content-center mt-4">
                                <a style="background: #212121;padding: 10px 20px;text-decoration: none;color: #fff;display: inline-block;margin: 30px 10px 0 0;border-radius: 5px;"
                                    href="emailconfirmation.php?id=<?php echo $candidats['idcand']; ?>">Envoyer un email
                                    de confirmation</a>
                                <a style="background: #212121;padding: 10px 18px;text-decoration: none;color: #fff;display: inline-block;margin: 30px 0;border-radius: 5px;"
                                    href="../pages/recrutement.php">Retour</a>
                            </ul>
                        </div>
                    </div>
                </div>
